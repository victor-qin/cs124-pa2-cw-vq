...
// cout << "conventiona, avg. duration: " << conv_duration.count() * 0.000001 / (double) trials << endl;
// cout << "strassen, avg. duration: " << stras_duration.count() * 0.000001 / (double) trials << endl;
// cout << endl;
